...
const {
  isString,
  unique,
} = require('article-parser/src/node_modules/bellajs');

const {hasProvider, extract: extractOembed} = require('article-parser/src/node_modules/oembed-parser');

const retrieve = require('article-parser/src/utils/retrieve');
const isValidUrl = require('article-parser/src/utils/isValidUrl');
const normalizeUrl = require('article-parser/src/utils/normalizeUrl');
const parseFromHtml = require('article-parser/src/utils/parseFromHtml');

const {
  info,
} = require('article-parser/src/utils/logger');
...
} = require('article-parser/src/config');
